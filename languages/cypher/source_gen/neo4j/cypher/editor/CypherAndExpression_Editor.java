...
public class CypherAndExpression_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_1zbjos_a(editorContext, node);
  }
  private EditorCell createCollection_1zbjos_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createIndent2(editorContext, node);
    editorCell.setCellId("Collection_1zbjos_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefNode_1zbjos_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_1zbjos_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_1zbjos_c0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_1zbjos_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new CypherAndExpression_Editor.leftExpressionSingleRoleHandler_1zbjos_a0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"), editorContext);
    return provider.createCell();
  }
  private class leftExpressionSingleRoleHandler_1zbjos_a0 extends SingleRoleCellProvider {
    public leftExpressionSingleRoleHandler_1zbjos_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1zbjos_b0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "AND");
    editorCell.setCellId("Constant_1zbjos_b0");
  ...
  private EditorCell createRefNode_1zbjos_c0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new CypherAndExpression_Editor.rightExpressionSingleRoleHandler_1zbjos_c0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11bL, "rightExpression"), editorContext);
    return provider.createCell();
  }
  private class rightExpressionSingleRoleHandler_1zbjos_c0 extends SingleRoleCellProvider {
    public rightExpressionSingleRoleHandler_1zbjos_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
