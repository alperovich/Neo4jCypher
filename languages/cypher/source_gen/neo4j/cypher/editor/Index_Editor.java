...
public class Index_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createAlternation_vwx1p9_a(EditorContext editorContext, SNode node) {
    ...
    alternationCondition = Index_Editor.renderingCondition_vwx1p9_a0(node, editorContext);
  ...
  private static boolean renderingCondition_vwx1p9_a0(SNode node, EditorContext editorContext) {
