...
public class QueryStringStatmentUntyped_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_7exkk3_a(editorContext, node);
  }
  private EditorCell createCollection_7exkk3_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_7exkk3_a");
    editorCell.setBig(true);
    editorCell.addEditorCell(this.createRefNode_7exkk3_a0(editorContext, node));
    editorCell.addEditorCell(this.createProperty_7exkk3_b0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_7exkk3_c0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_7exkk3_d0(editorContext, node));
    return editorCell;
  }
  private EditorCell createRefNode_7exkk3_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new QueryStringStatmentUntyped_Editor.typeSingleRoleHandler_7exkk3_a0(node, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x36087ce47f4eb88eL, 0x36087ce47f4eb88fL, "type"), editorContext);
    return provider.createCell();
  }
  private class typeSingleRoleHandler_7exkk3_a0 extends SingleRoleCellProvider {
    public typeSingleRoleHandler_7exkk3_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createProperty_7exkk3_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createConstant_7exkk3_c0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "=");
    editorCell.setCellId("Constant_7exkk3_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_7exkk3_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new QueryStringStatmentUntyped_Editor.queryExpressionSingleRoleHandler_7exkk3_d0(node, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x36087ce47f4eb88eL, 0x36087ce47f4eb892L, "queryExpression"), editorContext);
    return provider.createCell();
  }
  private class queryExpressionSingleRoleHandler_7exkk3_d0 extends SingleRoleCellProvider {
    public queryExpressionSingleRoleHandler_7exkk3_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
