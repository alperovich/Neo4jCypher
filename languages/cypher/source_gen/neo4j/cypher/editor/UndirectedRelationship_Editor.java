...
public class UndirectedRelationship_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_8hvahl_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new UndirectedRelationship_Editor.leftExpressionSingleRoleHandler_8hvahl_a0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"), editorContext);
    return provider.createCell();
  }
  private class leftExpressionSingleRoleHandler_8hvahl_a0 extends SingleRoleCellProvider {
    public leftExpressionSingleRoleHandler_8hvahl_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_8hvahl_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x637ffba7f2948fabL, "neo4j.cypher.structure.Relationship"), "neo4j.cypher.editor.RelationshipTypeChanges"));
  ...
  private EditorCell createRefNode_8hvahl_e0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new UndirectedRelationship_Editor.rightExpressionSingleRoleHandler_8hvahl_e0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11bL, "rightExpression"), editorContext);
    return provider.createCell();
  }
  private class rightExpressionSingleRoleHandler_8hvahl_e0 extends SingleRoleCellProvider {
    public rightExpressionSingleRoleHandler_8hvahl_e0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
