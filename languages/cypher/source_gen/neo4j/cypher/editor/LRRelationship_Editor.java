...
public class LRRelationship_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNode_fsr2fb_a0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new LRRelationship_Editor.leftExpressionSingleRoleHandler_fsr2fb_a0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11cL, "leftExpression"), editorContext);
    return provider.createCell();
  }
  private class leftExpressionSingleRoleHandler_fsr2fb_a0 extends SingleRoleCellProvider {
    public leftExpressionSingleRoleHandler_fsr2fb_a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_fsr2fb_e0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new LRRelationship_Editor.rightExpressionSingleRoleHandler_fsr2fb_e0(node, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbdeb6fecfL, 0xfbdeb7a11bL, "rightExpression"), editorContext);
    return provider.createCell();
  }
  private class rightExpressionSingleRoleHandler_fsr2fb_e0 extends SingleRoleCellProvider {
    public rightExpressionSingleRoleHandler_fsr2fb_e0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(ownerNode, containmentLink, context);
    }
    protected EditorCell createChildCell(SNode child) {
      myEditorContext.getCellFactory().pushCellContext();
