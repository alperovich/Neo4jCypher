...
public final class SetStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d600edL, "neo4j.cypher.structure.SetStatement");
  ...
  protected static Logger LOG = LogManager.getLogger(SetStatement__BehaviorDescriptor.class);
  /*package*/ static void joinWithTheSameNodeType_id6XfpfyXZTe6(@NotNull SNode __thisNode__, SNode otherIWriteStatement) {
    ...
    if (INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SNodeOperations.asNode(SNodeOperations.getConceptDeclaration(otherIWriteStatement))).equals(INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SNodeOperations.asNode(SNodeOperations.getConceptDeclaration(__thisNode__))))) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d600edL, 0x3528712027d600f0L, "setAssignmentStatement"))).addSequence(ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(otherIWriteStatement, MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d600edL, "neo4j.cypher.structure.SetStatement")), MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d600edL, 0x3528712027d600f0L, "setAssignmentStatement"))));
    }

  }

  /*package*/ SetStatement__BehaviorDescriptor() {
    super(REGISTRY);
  }
