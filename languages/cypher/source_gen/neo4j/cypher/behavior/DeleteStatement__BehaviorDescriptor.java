...
public final class DeleteStatement__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d6010bL, "neo4j.cypher.structure.DeleteStatement");
  ...
  protected static Logger LOG = LogManager.getLogger(DeleteStatement__BehaviorDescriptor.class);
  /*package*/ static void joinWithTheSameNodeType_id6XfpfyXZTe6(@NotNull SNode __thisNode__, SNode otherIWriteStatement) {
    ...
    if (INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SNodeOperations.asNode(SNodeOperations.getConceptDeclaration(otherIWriteStatement))).equals(INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(SNodeOperations.asNode(SNodeOperations.getConceptDeclaration(__thisNode__))))) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d6010bL, 0x3528712027d6010cL, "expression"))).addSequence(ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(otherIWriteStatement, MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d6010bL, "neo4j.cypher.structure.DeleteStatement")), MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3528712027d6010bL, 0x3528712027d6010cL, "expression"))));
    }
  }

  /*package*/ DeleteStatement__BehaviorDescriptor() {
    super(REGISTRY);
  }
