...
import jetbrains.mps.baseLanguage.behavior.PlusExpression__BehaviorDescriptor;
import jetbrains.mps.core.aspects.behaviour.api.SConstructor;
import org.jetbrains.annotations.Nullable;
import jetbrains.mps.core.aspects.behaviour.api.BHMethodNotFoundException;

public final class CypherPlusExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x12636aedaa50b941L, "neo4j.cypher.structure.CypherPlusExpression");
  ...
  /*package*/ static Object eval_idhEwJgmp(@NotNull SNode __thisNode__, SModule module) {
    ...
    if (leftExpression instanceof Integer && rightExpression instanceof Integer) {
      return as_3ui2uf_a0a0a2a01_0(leftExpression, Integer.class) + as_3ui2uf_a0a0a2a01(rightExpression, Integer.class);
    }

    return PlusExpression__BehaviorDescriptor.eval_idhEwJgmp.invokeSpecial(__thisNode__, module);
  }
  /*package*/ static int getPriority_id1653mnvAgo2(@NotNull SAbstractConcept __thisConcept__) {
    return 2;
  }

  /*package*/ CypherPlusExpression__BehaviorDescriptor() {
    super(REGISTRY);
  }
  ...
  private static <T> T as_3ui2uf_a0a0a2a01(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_3ui2uf_a0a0a2a01_0(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
}
