...
public class typeof_Neo4jQuery_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode neo4jQuery, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    // subtype <= supertype 
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(neo4jQuery, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x52178e8920cb2b25L, 0x52178e8920cb340eL, "graphDb"));
  ...
  public SAbstractConcept getApplicableConcept() {
    return MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x52178e8920cb2b25L, "neo4j.cypher.structure.Neo4jExec");
  }
  ...
  private static SNode _quotation_createNode_ac9gyn_a0b0b() {
    ...
    quotedNode_1.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), SReference.create(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), quotedNode_1, facade.createModelReference("8be426ea-f02f-4221-9d9f-9eb718c2d998/java:org.neo4j.graphdb(neo4j.cypher.runtime/)"), facade.createNodeId("~GraphDatabaseService")));
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_ac9gyn_a0c0b() {
    ...
    SNode quotedNode_1 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, "jetbrains.mps.baseLanguage.structure.ClassifierType"), null, null, false);
    quotedNode_1.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), SReference.create(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), quotedNode_1, facade.createModelReference("8be426ea-f02f-4221-9d9f-9eb718c2d998/java:org.neo4j.cypher.javacompat(neo4j.cypher.runtime/)"), facade.createNodeId("~ExecutionResult")));
    return quotedNode_1;
  }
}
