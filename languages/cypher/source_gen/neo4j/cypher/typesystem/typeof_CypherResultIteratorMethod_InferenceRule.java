...
public class typeof_CypherResultIteratorMethod_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode cypherResultIteratorMethod, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    final SNode operand = SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(cypherResultIteratorMethod), MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, "jetbrains.mps.baseLanguage.structure.DotExpression")), MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x116b46a08c4L, 0x116b46a4416L, "operand"));

    {
      ...
      typeCheckingContext.whenConcrete(queryType, new Runnable() {
        public void run() {
          SNode type = TypeChecker.getInstance().getRuntimeSupport().coerce_(typeCheckingContext.getExpandedNode(queryType), HUtil.createMatchingPatternByConcept(MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3340f286fb2bc7faL, "neo4j.cypher.structure.CypherResultTupleType")), true);
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:1549d4d9-195d-4192-a8ca-9bdca0139ffa(neo4j.cypher.typesystem)", "1942295127442522959", true), (SNode) _quotation_createNode_2vrcg5_a0b0c0b(SLinkOperations.getChildren(SLinkOperations.getTarget(type, MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x3340f286fb2bc7faL, 0x3340f286fb2bc98aL, "tupleType")), MetaAdapterFactory.getContainmentLink(0xa247e09e243545baL, 0xb8d207e93feba96aL, 0x1207157a8dcL, 0x1207158795cL, "componentType"))), _info_12389875345);
          }
        }
  ...
  public SAbstractConcept getApplicableConcept() {
    return MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x1af46b20b02c7309L, "neo4j.cypher.structure.CypherResultIteratorMethod");
  }
  ...
  private static SNode _quotation_createNode_2vrcg5_a0b0c0b(Object parameter_1) {
    ...
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration(MetaAdapterFactory.getConcept(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x1af46b20b02ee751L, "neo4j.cypher.structure.CypherResultIteratorTupleType"), null, null, false);
    ...
    quotedNode_2.addChild(MetaAdapterFactory.getContainmentLink(0xfa0e36f72d65493aL, 0x86382d9c4dbffdf7L, 0x1af46b20b02ee751L, 0x1af46b20b02ee757L, "tupleType"), quotedNode_3);
    return quotedNode_2;
  }
}
